...
APP下载地址：https://app.tmuyun.com/webChannels/invite?inviteCode=JE5MV9&tenantId=31&accountId=637909f0fe3fc118b0a926f1

cron 10 8,10 * * *  jryc.js

========= 青龙--配置文件--贴心复制区域  ========= 
# 今日越城 

安装依赖：yml2213-utils
export jryc='x-session-id' 
...
class UserInfo {
	constructor(str) { 			// 7. 构造函数  处理变量等    用 this 挂在对象上
		...
		this.xr = randomString(8)+"-"+randomString(4)+"-"+randomString(4)+"-"+randomString(4)+"-"+randomString(4)+"-"+randomString(12)
